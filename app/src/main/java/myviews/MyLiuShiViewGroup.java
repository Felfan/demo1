...
/**
 * Created by 房庆丰 on 2016/11/11.
 */
public class MyLiuShiViewGroup extends ViewGroup {
    private float mVerticalSpacing; //每个item纵向间距
    private float mHorizontalSpacing; //每个item横向间距

    public MyLiuShiViewGroup(Context context) {
        super(context);
    }
    public MyLiuShiViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
