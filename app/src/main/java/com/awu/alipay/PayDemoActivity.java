...
public class PayDemoActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mName = (TextView) this.findViewById(R.id.product_subject);
		mPrice = (TextView) this.findViewById(R.id.product_price);
		mName.setText(name);
		mPrice.setText(price);
	}

	/**
	 * call com.awu.alipay sdk pay. 调用SDK支付
	 */
	public void pay(View v) {
		...
		// 订单---
		String orderInfo = getOrderInfo(name, "暂时没有", price);
	...
	/**
	 * check whether the device has authentication com.awu.alipay account.
	 * 查询终端设备是否存在支付宝认证账户
	 * 
	 */
	...
	public String getOrderInfo(String subject, String body, String price) {
		...
		orderInfo += "&return_url=\"m.com.awu.alipay.com\"";
